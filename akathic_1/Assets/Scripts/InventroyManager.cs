...
public class InventroyManager : MonoBehaviour {
    ...
    public Canvas canvas;//Canva物体
    private Vector2 toolTipOffset =new Vector2(15, -10);//设置提示框跟随时与鼠标的偏移

    public  ItemUI pickedItem;//鼠标选中的物品的脚本组件，用于制作拖动功能 
        ...
        foreach (var temp in j.list)
        {
            ...
            switch (type)
            {
                case Item.ItemType.Consumable:
                    ...
                    item = new Consumable(id, name, type, quality, description, capacity,sprite, hp, mp);
                    break;
                case Item.ItemType.Equipment:
                    ...
                    item = new Equipment(id, name, type, quality, description, capacity, sprite,strength,intellect,agility,stamina,equiType);
                    break;
                case Item.ItemType.Weapon:
                    ...
                    item = new Weapon(id, name, type, quality, description, capacity , sprite , damage, weaponType);
                    break;
                case Item.ItemType.Task:
                    item = new Task(id, name, type, quality, description, capacity, sprite);
                    break;
            }
